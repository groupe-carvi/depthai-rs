...
include_cpp! {
    ...
    generate!("dai::dai_detection_network_get_input")
    generate!("dai::dai_detection_network_get_out")
    generate!("dai::dai_detection_network_get_out_network")
    generate!("dai::dai_detection_network_get_passthrough")
    generate!("dai::dai_detection_network_get_neural_network")
    generate!("dai::dai_detection_network_get_detection_parser")
    generate!("dai::dai_detection_network_set_nn_archive")
    generate!("dai::dai_detection_network_set_nn_archive_with_shaves")
    generate!("dai::dai_detection_network_set_from_model_zoo_json")
    generate!("dai::dai_detection_network_set_blob_path")
    generate!("dai::dai_detection_network_set_blob_bytes")
    generate!("dai::dai_detection_network_set_model_path")
    generate!("dai::dai_detection_network_set_num_pool_frames")
    generate!("dai::dai_detection_network_set_num_inference_threads")
    generate!("dai::dai_detection_network_get_num_inference_threads")
    generate!("dai::dai_detection_network_set_num_nce_per_inference_thread")
    generate!("dai::dai_detection_network_set_num_shaves_per_inference_thread")
    generate!("dai::dai_detection_network_set_backend")
    generate!("dai::dai_detection_network_set_backend_properties_json")
    generate!("dai::dai_detection_network_set_confidence_threshold")
    generate!("dai::dai_detection_network_get_confidence_threshold")
    generate!("dai::dai_detection_network_get_classes_json")
    generate!("dai::dai_detection_network_build_from_output")
    generate!("dai::dai_detection_network_build_from_camera_model_json")
    generate!("dai::dai_detection_network_build_from_camera_archive")
    generate!("dai::dai_detection_network_build_from_camera_model_capability_json")
    generate!("dai::dai_detection_network_build_from_camera_archive_capability_json")
    generate!("dai::dai_detection_parser_build_from_output")
    generate!("dai::dai_detection_parser_set_num_frames_pool")
    generate!("dai::dai_detection_parser_get_num_frames_pool")
    generate!("dai::dai_detection_parser_set_nn_archive")
    generate!("dai::dai_detection_parser_set_model_path")
    generate!("dai::dai_detection_parser_set_blob_path")
    generate!("dai::dai_detection_parser_set_blob_bytes")
    generate!("dai::dai_detection_parser_set_input_image_size")
    generate!("dai::dai_detection_parser_set_nn_family")
    generate!("dai::dai_detection_parser_get_nn_family")
    generate!("dai::dai_detection_parser_set_confidence_threshold")
    generate!("dai::dai_detection_parser_get_confidence_threshold")
    generate!("dai::dai_detection_parser_set_num_classes")
    generate!("dai::dai_detection_parser_get_num_classes")
    generate!("dai::dai_detection_parser_set_coordinate_size")
    generate!("dai::dai_detection_parser_get_coordinate_size")
    generate!("dai::dai_detection_parser_set_iou_threshold")
    generate!("dai::dai_detection_parser_get_iou_threshold")
    generate!("dai::dai_detection_parser_set_subtype")
    generate!("dai::dai_detection_parser_get_subtype")
    generate!("dai::dai_detection_parser_set_decode_keypoints")
    generate!("dai::dai_detection_parser_get_decode_keypoints")
    generate!("dai::dai_detection_parser_set_decode_segmentation")
    generate!("dai::dai_detection_parser_get_decode_segmentation")
    generate!("dai::dai_detection_parser_set_num_keypoints")
    generate!("dai::dai_detection_parser_get_num_keypoints")
    generate!("dai::dai_detection_parser_set_run_on_host")
    generate!("dai::dai_detection_parser_run_on_host")
    generate!("dai::dai_detection_parser_set_classes_json")
    generate!("dai::dai_detection_parser_get_classes_json")
    generate!("dai::dai_detection_parser_set_anchors_legacy_json")
    generate!("dai::dai_detection_parser_get_anchors_json")
    generate!("dai::dai_detection_parser_set_anchors_v2_json")
    generate!("dai::dai_detection_parser_set_anchor_masks_json")
    generate!("dai::dai_detection_parser_get_anchor_masks_json")
    generate!("dai::dai_detection_parser_set_strides_json")
    generate!("dai::dai_detection_parser_get_strides_json")
    generate!("dai::dai_detection_parser_set_keypoint_edges_json")
    ...
    generate!("dai::dai_datatype_as_img_detections")
    generate!("dai::dai_datatype_array_len")
    generate!("dai::dai_datatype_array_take")
    generate!("dai::dai_datatype_array_free")
    generate!("dai::dai_img_detections_new")
    generate!("dai::dai_img_detections_clone")
    generate!("dai::dai_img_detections_release")
    generate!("dai::dai_img_detections_as_buffer")
    generate!("dai::dai_img_detections_as_datatype")
    generate!("dai::dai_img_detections_get_count")
    generate!("dai::dai_img_detections_get_detections_json")
    generate!("dai::dai_img_detections_get_mask_info")
    generate!("dai::dai_img_detections_copy_mask")
...
pub type DaiImgDetections = *mut autocxx::c_void;
